...
try{
  ...
  assert.deepEqual(full.stages.map(stage=>stage.id),['intent','brief','research','validation','synthesis','data','interactive-result','presentation-story','narrative','slides']);

...
if(command==='serve'){
  const{serveAgentSuite}=await import('../api/agentsuite-api.mjs');await serveAgentSuite({host:option('--host','127.0.0.1'),port:Number(option('--port','8080')),rootDir:runtimeRoot});
}else{

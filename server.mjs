...
function templateVariantCss(slug) { const hash=[...String(slug)].reduce((sum,char)=>sum+char.charCodeAt(0),0); const n=hash%8; const tilt=((hash%7)-3)*.35; const titleSize=5.2+(hash%18)/10; const pad=5+(hash%22)/10; const radius=hash%5===0?28:hash%3===0?4:0; const variants=[

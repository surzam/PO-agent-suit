...
export class ObservationMode {
  ...
  render(state, meta = {}) {
    ...
    const resultStages = [
      stageById.get('interactive-result') || fallbackStage('interactive-result'),

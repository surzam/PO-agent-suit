...
export function createResearchService({ modelJson, sources = [], render, store, limits = {} }) {
  ...
  const operationDeadline=timeoutMs=>Number(timeoutMs)>0?new Date(Date.now()+Number(timeoutMs)).toISOString():null;

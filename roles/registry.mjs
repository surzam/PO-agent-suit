const definitions = [
  {
    ...
    displayCapabilities:['view.business-impact','view.tradeoff','view.evidence','view.validation']
  },
  {
    id: 'cto', label: 'CTO',
    ...
    displayCapabilities:['view.architecture','view.reliability','view.migration-risk','view.evidence','view.validation']
  }
];
...
export function createRoleRegistry(initial = definitions) {
  ...
  for (const role of initial) {
    ...
    roles.set(role.id, Object.freeze({ ...role, priorities:[...role.priorities], questions:[...role.questions], decisionCriteria:[...(role.decisionCriteria || [])],displayCapabilities:[...(role.displayCapabilities||[])] }));
  }
